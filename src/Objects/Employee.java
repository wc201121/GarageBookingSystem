...
public class Employee { //the different relations to an employee (Employee_ID makes it unique)
    ...
    public Employee(String Employee_Id, String Employee_Fname, String Employee_Lname, String Employee_Password, String Employee_Dept, String Employee_Phone, double Employee_HourlyRate) {
    ...
    public String getString (){ //allows us to retrieve and display employee (non sensitive) information
        return "Employee Id: " + Employee_Id + ", First name: " + Employee_Fname + ", Surname: " + Employee_Lname + ", Department: " + Employee_Dept + ", Office: " + ", Phone number: " + Employee_Phone;
    }
